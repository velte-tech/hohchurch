          ...
          <div className="min-group-showcase-parent">
            <div className="min-group-case-1">
              <div className="min-group-txt">
                <h1 className="focus-in-contract-bck">PARENTS</h1>
              </div>
            </div>
          </div>
          {/* showcase end */}
          ...
          <div className="pg-case">
            <div className="pg-show">
              <div className="pg">
                ...
                >
                  <div className="pgl">
                    <div className="pgl-1">NEXTGEN MINISTRIES</div>
                    <div className="pgl-2">
                      From cradle to college, we want to come alongside you to
                      help you grow in a relationship with Christ.NEXTGEN
                      Ministries include Kids, Students, College, and Parents
                      Ministry.
                    </div>
                    <div className="pgl-3">
            ...
            <div className="reset-show">
              <div className="reset">
                ...
                <div
                  ...
                  data-aos-delay="600"
                >
                  <div className="rrr-1">JOIN US</div>
                  <div className="rrr-2">
                    God chose YOU to raise your kid(s). That's a big job, so
                    let's take a minute to ReSet. Take a breath, follow Jesus &
                    lead with our Online Parenting Summit starting August 6.
                  </div>
                  <div className="rrr-3">
              ...
              <div className="ppcast-show">
                <div className="ppcast">
                  ...
                  <div
                    ...
                    data-aos-delay="600"
                  >
                    <div className="ppr-1">AT THE END OF THE DAY</div>
                    <div className="ppr-2">PODCAST</div>
                    <div className="ppr-3">
                ...
                <div className="recom">
                  ...
                  >
                    <div className="recom2-case">
                      <div className="recom2-11">
                        <Link className="btn">PARENT CUE APP</Link>
                      </div>
                      <div className="recom2-22">
                        Build a spiritual foundation for your kids with bible
                        story videos created for kids preschool to preteen and
                        daily devotionals for Kindergarten – 12th grade.
                      </div>
                    </div>

                    <div className="recom2-case">
                      <div className="recom2-11">
                        <Link className="btn">SUICIDE PREVENTION HOTLINE</Link>
                      </div>
                      <div className="recom2-22">
                    ...
                    <div className="recom2-case">
                      <div className="recom2-11">
                        <Link className="btn">AXES RESOURCES</Link>
                      </div>
                      <div className="recom2-22">
                        A massive library of culturally - relevant guides,
                        video, and audio for parents.
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="recom3-txt">
                      Our ultimate resource is the Bible as God’s Word and
                      authority in our life. Any resource listed on this page
                      does not equate to a full endorsement of the author’s
                      work. God chose you to be part of your family and we want
                      to partner with you through each stage. The selected
                      resources provide truth-based, relevant, and useful
                      materials to assist you along the way.
                    </div>
                  </div>
                </div>
              </div>
