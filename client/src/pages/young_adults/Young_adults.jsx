              ...
              <div className='ya-bot'>
                ...
                <div className="card_wrapper">
                  <div className="card">
                    ...
                    <div className="text">
                      <p>
                        YA SWING & LINE DANCING SOCIAL - JANUARY 2023
                        JANUARY 26, 2023
                      </p>
                      <p>The people have spoken! Our top rated social from last year is...</p>
                  ...
                  <div className="card">
                    ...
                    <div className="text">
                      <p>
                        YA FEBRUARY GATHERING
                        FEBRUARY 9, 2023
                      </p>
                      <p>Join us on the evening of Thursday, February 9th starting at 7pm in the...</p>
                      <Link className="linkAnima">
                        Learn More <span className="arrow"></span>
                      </Link>
                    </div>
                  ...
                  <div className="card">
                    ...
                    <div className="text">
                      <p>
                        BINGO AT BARQUENTINE!YA FEBRUARY SOCIAL
                        FEBRUARY 23, 2023
                      </p>
                      <p>Join us on the evening of Thursday, February 23rd at Barquentine...</p>
                      <Link className="linkAnima">
                        Learn More <span className="arrow"></span>
                      </Link>
                    </div>
            ...
            <div className='podd'>
              ...
              <div className='podcas'>
                <div className='pod-left'>
                  <div className='pod-pic hover_overlay_2'
                  data-aos="fade-right"
                  data-aos-anchor-placement="center-bottom"
                  data-aos-delay="600"
                  >
        ...
        <div className='ya-contact-wrapper'>
          <div className='ya-contact-case'>
            <div className='ya-contact'>
              <div className='yacon-1 focus-in-contract-bck'>
                CONTACT US</div>
