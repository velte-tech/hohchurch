        ...
        <div className='min-group-showcase-yac'>
          ...
          <div className='hurt-wrapper'>
            <div className='hurt-show'>
              <div className='hurt'>
                <div className='hurt-left'
                  data-aos="fade-right"
                  data-aos-anchor-placement="center-bottom"
                  data-aos-delay="600"
                >
                  <div className='hl-tt1'>
                    HELP FOR HURTING PEOPLE
                  </div>

                  <div className='hl-tt2'>
                    We understand that life gets hard and sometimes you need an intentional strategy
                    for change to work through your struggles.We provide several options to help meet your needs.Select one below
                    for more information.
                  </div>

                </div>

                <div className='hurt-right'
                  data-aos="fade-left"
                  data-aos-anchor-placement="center-bottom"
                  data-aos-delay="600"
                >
                  <div className='hr-top'>
                    ...
                    <div className='hrt2'>
                      For all Care Ministry Needs, please speak with your Campus Pastor or contact us directly at:
                    </div>
            ...
            <div className='detail-show'>
              <div className='detail-case'>
                ...
                <div className='d-txt3'>
                  ...
                  <span className='ddt2'>Lafayette Campus, West End Auditorium </span>
                </div>
                <div className='d-txt3'>
                ...
                <div className='d-txt3'>
                  <span className='ddt1'>Issue-Specific/Gender-Specific Small Groups:</span>
