            ...
            <div className='pr'>
              <div className='pr-1'>
                ...
                <div className='pr1-tt2'>
                  You are not alone in your situation! The Highway of Holiness Prayer Team exists to call on God for those in need. Please share your requests with us so that we can stand alongside you in prayer. If you need some additional support, let us know so that we can help you get connected with others at Flatirons that understand your struggle and can offer hope. Leave your contact info in the request if you need us to contact you.
                </div>
                <div className='pr1-tt3'>
                  When Life Hurts…Prayer Helps! If you need prayer, please submit the prayer request form on this page.
                </div>
              </div>
