        ...
        <div className="about_welcome container">
          ...
          <div className="right">
            <div className="card">
              ...
              <div className="text">
                <p className="hover_overlay">
                  SLICK CITY FAMILY NIGHT <br /> 1/19/2023
                </p>
                <p>Get ready for a night of community and FUN!!! Join the...</p>
            ...
            <div className="card">
              ...
              <div className="text">
                <p className="hover_overlay ">
                  GET CONNECTED OPEN HOUSE
                  <br />
                  01/22/2023
                </p>
                <p>
                  Join us for an Open House to learn more about Men's Connect
                  and Women's...
                </p>
                <Link to="/about" className="linkAnima">
                  Learn More <span className="arrow"></span>
            ...
            <div className="card">
              ...
              <div className="text">
                ...
                <p>
                  Join West Campus for a Winter Hike at Elk Meadow Park in
                  Evergreen. The...
                </p>
                <Link to="/about" className="linkAnima">
                  Learn More <span className="arrow"></span>
            ...
            <div className="card">
              ...
              <div className="text">
                ...
                <p>
                  Do Marriage Better! is a date night for couples. Join us
                  Friday, Feb...
                </p>
                <Link to="/about" className="linkAnima">
                  Learn More <span className="arrow"></span>
      ...
      <section id="west_reach">
        <div className="reach_wrapper">
          ...
          >
            ...
            <p>
              In 2019, Kim and I, and our children, Sarah Jane, Elijah, Ezekiel,
              and SoliDeo packed up our home. We left Kentucky to be part of
              what God is doing through Flatirons. Leaving family and friends
              was hard, but coming to Colorado has been so good. I first served
              on the Global Outreach team leading our work with international
              partners around the globe. Now, my family and I are with you West
              as we bring the awesome life of Christ to a lost and broken world.
            </p>
