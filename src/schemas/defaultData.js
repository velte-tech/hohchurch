...
export const homeContent = {
    ...
    missionCards: [
        {
            title: "Services & Time",
            description: "Find our service times and direction to our location.",
        },
        {
            title: "Outreach",
            description: "",
    ...
    pastMessagesTitle: "Past Messages",
    pastMessagesText: "Checkout our past sermons and services held by HOH-CHURCH.",
    pastMessages: [
        {
            youtubeId: "NAg3fUq66-o",
        },
        {
            youtubeId: "aDfTtKRBnBc",
        },
        {
            youtubeId: "ZQyO7YDV0Us",
        },
        {
            youtubeId: "L2gIEE64KbU",
        }
    ],
}
